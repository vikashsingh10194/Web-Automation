...
public class HotelsTestCase {
  ...
  @DataProviderParameters(path = Constant.TH_HOTELS_TESTDATA, sheetName = Constant.HOTELS_SHEETNAME,parallel=true)
  public void hotelsSearchValidation(String testId, Map<Integer, String> testData) {
    HotelTestFlowExecuter hotelTestExecuter =
        new HotelTestFlowExecuter(VIA_COUNTRY.TH, testId, driver, repositoryParser);
