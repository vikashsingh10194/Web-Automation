...
public class HotelsTestCase {
  ...
  @DataProviderParameters(path = Constant.OM_HOTELS_TESTDATA, sheetName = Constant.HOTELS_SHEETNAME,parallel=true)
  public void hotelsSearchValidation(String testId, Map<Integer, String> testData) {
    HotelTestFlowExecuter hotelTestExecuter =
        new HotelTestFlowExecuter(VIA_COUNTRY.OM, testId, driver, repositoryParser);
