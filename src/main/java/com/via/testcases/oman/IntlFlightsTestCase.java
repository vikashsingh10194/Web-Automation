package com.via.testcases.oman;
...
public class IntlFlightsTestCase {
  ...
  @DataProviderParameters(path = Constant.OM_FLIGHTS_TESTDATA,
  ...
  public void flightsSearchValidation(String testId, Map<Integer, String> testData) {
    IntlFlightTestFlowExecuter flightTestExecuter =
        new IntlFlightTestFlowExecuter(VIA_COUNTRY.OM, testId, Flight.INTERNATIONAL, driver,
            repositoryParser);
