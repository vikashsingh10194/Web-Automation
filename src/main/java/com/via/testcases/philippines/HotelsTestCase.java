...
public class HotelsTestCase {
  ...
  @DataProviderParameters(path = Constant.PH_HOTELS_TESTDATA, sheetName = Constant.HOTELS_SHEETNAME,parallel=true)
  public void hotelsSearchValidation(String testId, Map<Integer, String> testData) {
    HotelTestFlowExecuter hotelTestExecuter =
        new HotelTestFlowExecuter(VIA_COUNTRY.PH, testId, driver, repositoryParser);
