...
import com.via.testcases.common.TrainTestFlowExecuter;
...
public class TrainsTestCase {
  ...
  @DataProviderParameters(path = Constant.ID_TRAINS_TESTDATA, sheetName = Constant.TRAINS_SHEETNAME,parallel=true)
  public void hotelsSearchValidation(String testId, Map<Integer, String> testData) {
    TrainTestFlowExecuter railTestExecuter =
        new TrainTestFlowExecuter(VIA_COUNTRY.ID, testId, driver, BOOKING_MEDIA.B2C,
            repositoryParser);
    railTestExecuter.execute(testData);
  }
}
