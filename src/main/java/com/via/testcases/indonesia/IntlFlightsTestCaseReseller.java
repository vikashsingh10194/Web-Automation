...
public class IntlFlightsTestCaseReseller {
  ...
  public void datafetch() {
    ...
    repositoryParser.transactionRuleLoader(VIA_COUNTRY.ID, Constant.ID_TRANSACTION_RULE_JSON);
  ...
  @DataProviderParameters(path = Constant.ID_FLIGHTS_TESTDATA,
  ...
  private void executeTest(WebDriver driver, String testId, Map<Integer, String> testData) {
    IntlFlightTestFlowExecuter flightTestExecuter =
        new IntlFlightTestFlowExecuter(VIA_COUNTRY.ID, testId, Flight.INTERNATIONAL, driver,
            repositoryParser);
