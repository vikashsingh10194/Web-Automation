package com.via.testcases.hongkong;
...
import com.via.testcases.common.HolidayTestFlowExecuter;
...
public class HolidaysTestCase {
  ...
  @DataProviderParameters(path = Constant.SG_HOLIDAYS_TESTDATA,
      sheetName = Constant.HOLIDAYS_SHEETNAME, parallel = true)
  public void holidaysSearchValidation(String testId, Map<Integer, String> testData) {
    HolidayTestFlowExecuter holidayTestExecuter =
        new HolidayTestFlowExecuter(VIA_COUNTRY.SG, testId, driver, repositoryParser);
