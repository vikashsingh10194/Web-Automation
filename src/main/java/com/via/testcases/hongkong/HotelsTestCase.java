...
public class HotelsTestCase {
  ...
  @DataProviderParameters(path = Constant.SG_HOTELS_TESTDATA,
      sheetName = Constant.HOTELS_SHEETNAME, parallel = true)
  public void hotelsSearchValidation(String testId, Map<Integer, String> testData) {
    HotelTestFlowExecuter hotelTestExecuter =
        new HotelTestFlowExecuter(VIA_COUNTRY.SG, testId, driver, repositoryParser);
