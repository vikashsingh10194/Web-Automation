...
public class IntlFlightsTestCase {
  ...
  public void dataFetch() {
    ...
    repositoryParser.transactionRuleLoader(VIA_COUNTRY.UAE, Constant.UAE_TRANSACTION_RULE_JSON);
    repositoryParser.loadConfigProperties();

    EntityMap.replaceAirportCity("JAKARTA", "Soekarno Hatta Intl - Indonesia");
    EntityMap.replaceAirportCity("KOCHI", CityConstantsFlights.KCZ);
  }
  ...
  @DataProviderParameters(path = Constant.UAE_FLIGHTS_TESTDATA,
  ...
  public void flightsSearchValidation(String testId, Map<Integer, String> testData) {
    IntlFlightTestFlowExecuter flightTestExecuter =
        new IntlFlightTestFlowExecuter(VIA_COUNTRY.UAE, testId, Flight.INTERNATIONAL, driver,
            repositoryParser);
